...
#ad_ip_instance axi_iic axi_iic_kria
#ad_ip_parameter axi_iic_kria CONFIG.USE_BOARD_FLOW true
#ad_ip_parameter axi_iic_kria CONFIG.IIC_BOARD_INTERFACE Custom

#make_bd_intf_pins_external [get_bd_intf_pins axi_iic_kria/IIC]

#ad_connect axi_iic_kria/s_axi_aclk $sys_cpu_clk
#ad_connect axi_iic_kria/s_axi_aresetn $sys_cpu_resetn

ad_cpu_interconnect 0x44A00000 axi_sysid_0
#ad_cpu_interconnect 0x44A20000 axi_iic_kria

#ad_cpu_interrupt ps-10 mb-5 axi_iic_kria/iic2intc_irpt
