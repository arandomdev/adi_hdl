...
#
#    e.g.
#      make JESD_MODE=64B66B RX_LANE_RATE=24.75 RX_JESD_L=4
#      make JESD_MODE=64B66B RX_LANE_RATE=16.22016 RX_JESD_M=8 RX_JESD_L=2 TX_JESD_M=16 TX_JESD_L=4
...
adi_project_files ad9209_fmca_ebz_vcu118 [list \
  "system_top.v" \
  "system_constr.xdc"\
  "timing_constr.xdc"\
