...
set_property         -dict {PACKAGE_PIN AG7                                     } [get_ports rx_data_n[2]     ]    ; ## FMC0_DP2_M2C_N      MGTXRXN2_109     FPGA_SERDIN_0_N
set_property         -dict {PACKAGE_PIN AG8                                     } [get_ports rx_data_p[2]     ]    ; ## FMC0_DP2_M2C_P      MGTXRXP2_109     FPGA_SERDIN_0_P
set_property         -dict {PACKAGE_PIN AH9                                     } [get_ports rx_data_n[0]     ]    ; ## FMC0_DP0_M2C_N      MGTXRXN0_109     FPGA_SERDIN_1_N
set_property         -dict {PACKAGE_PIN AH10                                    } [get_ports rx_data_p[0]     ]    ; ## FMC0_DP0_M2C_P      MGTXRXP0_109     FPGA_SERDIN_1_P
set_property         -dict {PACKAGE_PIN AD5                                     } [get_ports rx_data_n[7]     ]    ; ## FMC0_DP7_M2C_N      MGTXRXN3_110     FPGA_SERDIN_2_N
set_property         -dict {PACKAGE_PIN AD6                                     } [get_ports rx_data_p[7]     ]    ; ## FMC0_DP7_M2C_P      MGTXRXP3_110     FPGA_SERDIN_2_P
set_property         -dict {PACKAGE_PIN AF5                                     } [get_ports rx_data_n[6]     ]    ; ## FMC0_DP6_M2C_N      MGTXRXN2_110     FPGA_SERDIN_3_N
set_property         -dict {PACKAGE_PIN AF6                                     } [get_ports rx_data_p[6]     ]    ; ## FMC0_DP6_M2C_P      MGTXRXP2_110     FPGA_SERDIN_3_P
set_property         -dict {PACKAGE_PIN AG3                                     } [get_ports rx_data_n[5]     ]    ; ## FMC0_DP5_M2C_N      MGTXRXN1_110     FPGA_SERDIN_4_N
set_property         -dict {PACKAGE_PIN AG4                                     } [get_ports rx_data_p[5]     ]    ; ## FMC0_DP5_M2C_P      MGTXRXP1_110     FPGA_SERDIN_4_P
set_property         -dict {PACKAGE_PIN AH5                                     } [get_ports rx_data_n[4]     ]    ; ## FMC0_DP4_M2C_N      MGTXRXN0_110     FPGA_SERDIN_5_N
set_property         -dict {PACKAGE_PIN AH6                                     } [get_ports rx_data_p[4]     ]    ; ## FMC0_DP4_M2C_P      MGTXRXP0_110     FPGA_SERDIN_5_P
set_property         -dict {PACKAGE_PIN AE7                                     } [get_ports rx_data_n[3]     ]    ; ## FMC0_DP3_M2C_N      MGTXRXN3_109     FPGA_SERDIN_6_N
set_property         -dict {PACKAGE_PIN AE8                                     } [get_ports rx_data_p[3]     ]    ; ## FMC0_DP3_M2C_P      MGTXRXP3_109     FPGA_SERDIN_6_P
set_property         -dict {PACKAGE_PIN AJ7                                     } [get_ports rx_data_n[1]     ]    ; ## FMC0_DP1_M2C_N      MGTXRXN1_109     FPGA_SERDIN_7_N
set_property         -dict {PACKAGE_PIN AJ8                                     } [get_ports rx_data_p[1]     ]    ; ## FMC0_DP1_M2C_P      MGTXRXP1_109     FPGA_SERDIN_7_P
set_property         -dict {PACKAGE_PIN AH21  IOSTANDARD LVDS_25                } [get_ports fpga_syncout_0_n ]    ; ## FMC0_LA01_CC_N      IO_L13N_T2_MRCC_11
set_property         -dict {PACKAGE_PIN AG21  IOSTANDARD LVDS_25                } [get_ports fpga_syncout_0_p ]    ; ## FMC0_LA01_CC_P      IO_L13P_T2_MRCC_11
set_property         -dict {PACKAGE_PIN AH22  IOSTANDARD LVCMOS25               } [get_ports fpga_syncout_1_n ]    ; ## FMC0_LA06_N         IO_L6N_T0_VREF_11
set_property         -dict {PACKAGE_PIN AG22  IOSTANDARD LVCMOS25               } [get_ports fpga_syncout_1_p ]    ; ## FMC0_LA06_P         IO_L6P_T0_11
