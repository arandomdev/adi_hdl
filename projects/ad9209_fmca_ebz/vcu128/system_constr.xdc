...
set_property         -dict {PACKAGE_PIN BA54                                           } [get_ports rx_data_n[2]              ]    ; ## MGTYRXN2_124              FPGA_SERDIN_0_N
set_property         -dict {PACKAGE_PIN BA53                                           } [get_ports rx_data_p[2]              ]    ; ## MGTYRXP2_124              FPGA_SERDIN_0_P
set_property         -dict {PACKAGE_PIN BC54                                           } [get_ports rx_data_n[0]              ]    ; ## MGTYRXN0_124              FPGA_SERDIN_1_N
set_property         -dict {PACKAGE_PIN BC53                                           } [get_ports rx_data_p[0]              ]    ; ## MGTYRXP0_124              FPGA_SERDIN_1_P
set_property         -dict {PACKAGE_PIN AV52                                           } [get_ports rx_data_n[7]              ]    ; ## MGTYRXN3_125              FPGA_SERDIN_2_N
set_property         -dict {PACKAGE_PIN AV51                                           } [get_ports rx_data_p[7]              ]    ; ## MGTYRXP3_125              FPGA_SERDIN_2_P
set_property         -dict {PACKAGE_PIN AW50                                           } [get_ports rx_data_n[6]              ]    ; ## MGTYRXN2_125              FPGA_SERDIN_3_N
set_property         -dict {PACKAGE_PIN AW49                                           } [get_ports rx_data_p[6]              ]    ; ## MGTYRXP2_125              FPGA_SERDIN_3_P
set_property         -dict {PACKAGE_PIN AW54                                           } [get_ports rx_data_n[5]              ]    ; ## MGTYRXN1_125              FPGA_SERDIN_4_N
set_property         -dict {PACKAGE_PIN AW53                                           } [get_ports rx_data_p[5]              ]    ; ## MGTYRXP1_125              FPGA_SERDIN_4_P
set_property         -dict {PACKAGE_PIN AY52                                           } [get_ports rx_data_n[4]              ]    ; ## MGTYRXN0_125              FPGA_SERDIN_5_N
set_property         -dict {PACKAGE_PIN AY51                                           } [get_ports rx_data_p[4]              ]    ; ## MGTYRXP0_125              FPGA_SERDIN_5_P
set_property         -dict {PACKAGE_PIN BA50                                           } [get_ports rx_data_n[3]              ]    ; ## MGTYRXN3_124              FPGA_SERDIN_6_N
set_property         -dict {PACKAGE_PIN BA49                                           } [get_ports rx_data_p[3]              ]    ; ## MGTYRXP3_124              FPGA_SERDIN_6_P
set_property         -dict {PACKAGE_PIN BB52                                           } [get_ports rx_data_n[1]              ]    ; ## MGTYRXN1_124              FPGA_SERDIN_7_N
set_property         -dict {PACKAGE_PIN BB51                                           } [get_ports rx_data_p[1]              ]    ; ## MGTYRXP1_124              FPGA_SERDIN_7_P       
set_property         -dict {PACKAGE_PIN F25  IOSTANDARD LVDS                           } [get_ports fpga_syncout_0_n          ]    ; ## IO_L14N_T2L_N3_GC_72      
set_property         -dict {PACKAGE_PIN F26  IOSTANDARD LVDS                           } [get_ports fpga_syncout_0_p          ]    ; ## IO_L14P_T2L_N2_GC_72      
set_property         -dict {PACKAGE_PIN D22  IOSTANDARD LVCMOS18                       } [get_ports fpga_syncout_1_n          ]    ; ## IO_L15N_T2L_N5_AD11N_72   
set_property         -dict {PACKAGE_PIN E22  IOSTANDARD LVCMOS18                       } [get_ports fpga_syncout_1_p          ]    ; ## IO_L15P_T2L_N4_AD11P_72   
